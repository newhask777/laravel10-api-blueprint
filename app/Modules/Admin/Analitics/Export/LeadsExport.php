...
//        dd(DateServiceFacade::isValid($dateStart, "d.m.Y"));

        $this->dateStart = new Carbon('first day of this month');
        if($dateStart && DateServiceFacade::isValid($dateStart, "d.m.Y")) {
            $this->dateStart = Carbon::parse($dateStart);
        }

        $this->dateEnd = new Carbon('last day of this month');
        if($dateEnd && DateServiceFacade::isValid($dateEnd, "d.m.Y")) {
