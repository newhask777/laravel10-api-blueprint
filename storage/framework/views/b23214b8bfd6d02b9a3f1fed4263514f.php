...
<div class="content">
    ...
    <!-- Input group addons -->
    <div class="box card">
        <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(route('roles.store')); ?>">
...
<?php /**PATH C:\Users\hask777\Desktop\projects\PHP\laravel10-api-passport\resources\views/Admin/Role/create.blade.php ENDPATH**/ ?>